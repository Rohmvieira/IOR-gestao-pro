...
const MODULES  = ["Dashboard","CRM Leads","CRM Produtos","Alunos","Cursos","Financeiro","Checklist","WA Lembretes","Painel Pedagógico","Permissões","Social"];
    ...
    {tab==="calendario"&&<>
      <div style={{background:"#fff",borderRadius:16,border:"1px solid var(--b)",overflow:"hidden",boxShadow:"var(--shadow)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(7,1fr)"}}>
          ...
          {Array.from({length:dm}).map((_,i)=>{const day=i+1,dps=postsOnDay(day);const isToday=new Date().getDate()===day&&new Date().getMonth()===cm&&new Date().getFullYear()===cy;return <div key={day} style={{borderRight:"1px solid var(--b)",borderBottom:"1px solid var(--b)",minHeight:80,padding:5,overflow:"hidden",minWidth:0}}>
